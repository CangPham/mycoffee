...
if ( !function_exists('ltx_get_fa5_icons') ) {
	...
	function coffeeking_fw_add_more_packs( $default_packs ) {

		$packs = array();
/*
		$file = coffeeking_get_fontello_css();
		$fontello = coffeeking_get_fontello_path();

		if ( !empty($file) ) {

			$packs['coffeeking_theme_icons'] = array(

				'name' => 'coffeeking_theme_icons',
				'title' => 'Coffeeking Theme Icons',
				'css_class_prefix' => 'icon',

				'css_file' => $file,
				'css_file_uri' => $fontello['css']['url'],

				'admin_wp_enqueue_handle' => 'coffeeking-fontello',
				'frontend_wp_enqueue_handle' => 'coffeeking-fontello',
...
*/
		$packs['coffeeking_fa5_icons'] = array(
				
			'name' => 'coffeeking_fa5_icons',
			'title' => 'Font Awesome 5 Free',

			'admin_wp_enqueue_handle' => 'coffeeking-fontawesome-5',
			'frontend_wp_enqueue_handle' => 'coffeeking-fontawesome-5',
	...
	add_filter( 'fw:option_type:icon-v2:packs', 'coffeeking_fw_add_more_packs' );			

	function coffeeking_fw_custom_packs($current_packs) {

	    return array('coffeeking_fa5_icons', 'coffeeking_theme_icons');
	}

	add_filter('fw:option_type:icon-v2:filter_packs', 'coffeeking_fw_custom_packs');	
}
