...
echo '<div '. $id .' data-marker="'.esc_url(get_template_directory_uri()).'/assets/images/location-black.png" class="like-google-maps" data-style="'. esc_attr($args['style']) .'" data-lng="'. esc_attr($args['lng']) .'" data-lat="'. esc_attr($args['lat']) .'" data-zoom="'. esc_attr($args['zoom']) .'" style="width: '.esc_attr($args['width']).'; height: '.esc_attr($args['height']).';">'.$warning.'</div>';
